...
class Peminjaman {
    ...
    public function create() {
        ...
        try {
            ...
            if (!$this->stokBukuModel->updateStok($this->id_buku, $new_stok)) {
            ...
            error_log("Error in Peminjaman::create(): " . $e->getMessage());
            return false;
        }
    }
    ...
    public function returnBook($id_peminjaman) {
        ...
        try {
            ...
            if (!$this->stokBukuModel->updateStok($peminjaman_data['id_buku'], $new_stok)) {
                throw new Exception("Gagal memperbarui stok buku setelah pengembalian.");
            }
            ...
            $this->conn->rollBack();
            $_SESSION['error'] = $e->getMessage();
            error_log("Error in Peminjaman::returnBook(): " . $e->getMessage());
            return false;
        }
    }
    ...
    public function getLoanById($id_peminjaman) {
        $query = "SELECT id_peminjaman, nim_mahasiswa, id_buku, tanggal_pinjam, tanggal_kembali_maksimal, tanggal_kembali_aktual, status
